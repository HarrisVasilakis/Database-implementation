...
int main(char argc,char** argv)
{
	...
	*/
	...
	for (int i=0;i<testRecordsNumber;i++)
	{
		...
		//hi=HT_OpenIndex(fileName);
		//printf("YOAAAAAAAAAAAAAAAAAA%ld \n",hi->numBuckets);
	...
	*/
	...
	BF_ReadBlock(hi->fileDesc,1,&newblock);
	memcpy(re2,newblock,sizeof(blockstruct));
	printf("%s %sVVVVVVVVVVVVVVVVVVVVV\n",re2->rec[5].name,re2->rec[5].address);*/
